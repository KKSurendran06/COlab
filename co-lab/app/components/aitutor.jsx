...
export default function AICharacterTutor() {
  ...
  const fetchAIResponse = async () => {
    ...
    const apiKey = "AIzaSyC5JJ8UDOsoyVTIGZDFwvUdF0zV6liVHfs"; // Replace with your actual API key
          ...
          <div className="bg-white rounded-xl shadow-lg p-4 flex-1 flex flex-col">
            ...
            <div className="flex flex-col gap-2 mt-4">
              <button
                ...
                className={`py-3 px-6 rounded-lg text-white font-bold transition-all ${
