          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
              ...
              <div className="bg-white rounded-3xl shadow-sm overflow-hidden md:col-span-2 border-2 border-black">
                <div className="p-6">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <a href="#" className="text-[#ff5722] text-sm font-medium hover:underline">View all groups</a>
                  </div>
              ...
              <div className="bg-[#333333] text-white rounded-xl shadow-sm overflow-hidden border border-[#444444]">
                <div className="p-6">
                  <h2 className="text-lg font-semibold mb-2">New group matching your interests</h2>
                  ...
                  <div className="bg-[#444444] rounded-lg p-4 mt-4">
                        ...
                        <div className="mt-3">
                          <div className="flex -space-x-2 overflow-hidden mb-2">
                            ...
                            <div className="inline-block h-8 w-8 rounded-full ring-2 ring-white bg-blue-500 flex items-center justify-center">
                              {getInitials(userGroups[0]?.creatorName || 'User')}
                            </div>
                          ...
                          <p className="text-gray-300 text-sm">They are already studying</p>
                        </div>
                    ...
                    {userGroups.length === 0 && (
                      <>
                        <span className="inline-block px-3 py-1 bg-yellow-500 text-black text-xs font-medium rounded-full mb-2">Computer Science</span>
                        <h3 className="text-xl font-bold mb-4">No groups available</h3>
                        <p className="text-gray-300 text-sm">Create a group to get started!</p>
                        <button 
                          onClick={handleCreateGroup}
